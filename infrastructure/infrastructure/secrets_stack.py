...
class SecretsStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, database_secrets: aws_secretsmanager.ISecret, **kwargs) -> None:
        ...
        self.secrets = {
            ...
            "CELERY_BROKER_URL": aws_ecs.Secret.from_secrets_manager(self._from_secret_name("CELERY_BROKER_URL")),  # nosec
            "GEOCODE_API_KEY": aws_ecs.Secret.from_secrets_manager(self._from_secret_name("GEOCODE_API_KEY")),  # nosec
